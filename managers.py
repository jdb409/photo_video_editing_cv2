...
class CaptureManager:
    ...
    def exitFrame(self):
        ...
        # getting can retrieve and cache the frame
    ...
    def _writeVideoFrame(self):
        ...
        if (self._videoWriter is None):
            ...
            if (fps == 0.0):
                ...
                # capture fps is unknown so use estimate
            ...
            size = (int(self._capture.get(cv2.CAP_PROP_FRAME_WIDTH)), int(self._capture.get(
